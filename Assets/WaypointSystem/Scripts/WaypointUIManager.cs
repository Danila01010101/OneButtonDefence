...
namespace WrightAngle.Waypoint
{
    ...
    public class WaypointUIManager : MonoBehaviour
    {
        ...
        public static Action<WaypointTarget> OnWaypointTargetAdd;
        ...
        private void OnDestroy()
        {
            ...
            WaypointTarget.OnTargetEnabled -= HandleTargetEnabled;
            WaypointTarget.OnTargetDisabled -= HandleTargetDisabled;
            OnWaypointTargetAdd -= RegisterTarget;
        ...
        // --- Initializator ---
        public void Initializator(Camera camera, RectTransform canvas, WaypointSettings data)
        {
            waypointCamera = camera;
            markerParentCanvas = canvas;
            settings = data;
